    ...
    <script>
        ...
        function processSilInput(silValue) {
            ...
            if (entries.length > 0) {
                ...
                $.ajax({
                    url: '<?= $baseUrl; ?>CONTROLLER/TAM/3P_TAM_SIL.php',
                    type: 'POST',
        ...
        function createDynamicPHPFile(noSil, entries) {
            $.ajax({
                url: '<?php echo $baseUrl; ?>VIEW/OPERATIONAL/REGULER/TAM/3P_TAM_GENERATOR.php',
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify({
                    noSil: noSil,
        ...
        function deleteEntry(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?= $baseUrl; ?>VIEW/OPERATIONAL/REGULER/TAM/3P_TAM_DELETE.php',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            numSil: numberSils
